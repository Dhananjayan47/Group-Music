...
const Login = () => {
    ...
    useEffect(() => {
        if (!exitMsg) return;
        setNotification({ show: true, msg: exitMsg, variant: "warning" });
    }, [exitMsg]);
    ...
    const handleSubmit = async (e) => {
        ...
        if (!userDetails.email || !userDetails.password) {
            return setNotification({
                msg: "Fill the all the field before submit",
                show: true,
                variant: "danger",
            });
        }
...
const VerifyPage = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            if (!otp)
                return setNotification({
                    msg: "Fill the OTP field before submit",
                    show: true,
                    variant: "danger",
                });
            setIsSubmit(true);
            ...
            <div className="position-relative d-flex justify-content-center align-items-center col-lg-4 col-md-6 col-sm-8 vh-100">
                ...
                >
                    <MyModal
                        ...
                        content={
                            <>
                                If you do not get the OTP in your inbox, please
                                check the <strong>Spam folder</strong>.
                            </>
                        }
                        confirmText="?"
                    />
